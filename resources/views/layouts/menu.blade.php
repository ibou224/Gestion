  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="assets/dist/img/devise.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('fournisseur')}} " class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Fournisseurs
              </p>
          ...
          <li class="nav-item">
            <a href="{{route('entrer')}} " class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Entrer
              </p>
          ...
          <li class="nav-item">
            <a href="{{route('sortier')}} " class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Sortiers
              </p>
